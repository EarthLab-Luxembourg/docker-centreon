...
docker run -d \
 ...
 -v "${host_volumes_path}/volumes/etc/centreon-gorgone:/etc/centreon-gorgone" \
 ...
 -v "${host_volumes_path}/volumes/var/lib/centreon-gorgone:/var/lib/centreon-gorgone" \
 -v "${host_volumes_path}/volumes/var/log/centreon-gorgone:/var/log/centreon-gorgone" \
